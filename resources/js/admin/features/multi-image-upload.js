                ...
                card.innerHTML = `
                    ...
                    <div class="p-3 bg-white flex-1 flex flex-col gap-2 border-t border-gray-100">
                        <div>
                            ...
                            <input type="text" name="new_alts[${index}]" value="${savedAlt.replace(/"/g, '&quot;')}" placeholder="Opsional..." class="w-full text-[10px] border border-gray-200 rounded px-1.5 py-1 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors">
                        </div>
                        ${this.hideCover ? '' : `
                        <label class="flex items-center gap-1.5 cursor-pointer mt-auto pt-1">
                            <input type="radio" name="new_cover" value="${index}" ${isChecked ? 'checked' : ''} class="w-3.5 h-3.5 text-primary focus:ring-primary border-gray-300">
