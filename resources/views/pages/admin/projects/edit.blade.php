                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-1">
                            <x-admin.forms.image-upload id="thumbnail" name="thumbnail" label="Gambar Utama (Thumbnail)"
                                :required="false"
                                helpText="Gambar ini akan tampil pertama di card slider. Biarkan kosong jika tidak ingin mengubah gambar. Format: JPG, PNG, WEBP. Maks 2MB."
                                :currentImage="$project->thumbnail" />
                        </div>

                        <!-- Gallery Multi Upload -->
                        <div class="md:col-span-1">
                            <x-admin.forms.multi-image-upload id="gallery" name="images[]" label="Tambah Gambar Galeri (Opsional)"
                                :required="false" :hideCover="true" />
                        </div>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <button type="button" onclick="confirmDeleteImage({{ $image->id }})"
                                        class="bg-red-500 hover:bg-red-600 text-white p-2 rounded-full transform scale-75 group-hover:scale-100 transition-all duration-200 shadow-lg"
                                        title="Hapus Gambar">
