        ...
        <div class="bg-white rounded-md shadow-sm border border-gray-100 overflow-hidden">
            <div class="p-6">
                <form action="{{ route('admin.projects.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-1">
                            <x-admin.forms.image-upload id="thumbnail" name="thumbnail" label="Gambar Utama (Thumbnail)"
                                :required="true" helpText="Gambar ini akan tampil pertama di card slider. Format: JPG, PNG, WEBP. Maks 2MB." />
                        </div>

                        <!-- Gallery Multi Upload -->
                        <div class="md:col-span-1">
                            <x-admin.forms.multi-image-upload id="gallery" name="images[]" label="Gambar Galeri (Opsional)"
                    ...
                    <div class="flex items-center justify-end gap-2 sm:gap-3 pt-5 sm:pt-6 mt-5 sm:mt-6 border-t border-gray-100">
