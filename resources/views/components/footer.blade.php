<footer class="w-full relative bg-black border-t border-white/5 font-AbhayaLibre pt-16 pb-6 overflow-hidden">
    <!-- Ambient Glow Background -->
    <div
        class="absolute bottom-0 left-1/2 -translate-x-1/2 w-[800px] h-[300px] bg-blue-500/10 blur-[120px] rounded-full pointer-events-none">
    </div>

    <div class="container relative z-10 mx-auto px-6 md:px-12 lg:px-20">

        <!-- Main Footer Content -->
        <div class="grid grid-cols-2 lg:grid-cols-12 gap-x-6 gap-y-12 lg:gap-8 mb-10 md:mb-16">

            <!-- Col 1: Brand & Socials (Span 4) -->
            <div class="col-span-2 md:col-span-1 lg:col-span-4 flex flex-col">
                <h2 class="text-[28px] md:text-[32px] font-Alconica text-white mb-6 tracking-wide drop-shadow-md">
                    I'Exxass
                </h2>

                <p class="text-gray-300 text-[15px] leading-[1.8] mb-6 max-w-sm">
                    Jl. Perum Bukit Tiara No. C6/05, Pasir Jaya, Cikupa, Tangerang, Banten 15710.
                </p>

                <div class="flex flex-col items-start gap-2 mb-8">
                    <a href="mailto:customer.care@iexxass.com"
                        class="text-gray-400 hover:text-white text-[13px] md:text-[14px] transition-colors duration-300 inline-flex items-center gap-2 group">
                        <svg class="w-4 h-4 text-blue-400 group-hover:text-white transition-colors" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z">
                            </path>
                        </svg>
                        customer.care@iexxass.com
                    </a>
                    <a href="mailto:support@iexxass.com"
                        class="text-gray-400 hover:text-white text-[13px] md:text-[14px] transition-colors duration-300 inline-flex items-center gap-2 group">
                        <svg class="w-4 h-4 text-blue-400 group-hover:text-white transition-colors" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="flex flex-col items-start gap-3">
                    ...
                    <a href="#network" data-target="network"
                        ...
                        <span
                            class="absolute left-0 w-1.5 h-1.5 rounded-full bg-blue-400 opacity-0 group-hover:opacity-100 group-focus:opacity-100 transition-all duration-300 scale-0 group-hover:scale-100 group-focus:scale-100"></span>
                        <span
                            class="transition-transform duration-300 group-hover:translate-x-4 group-focus:translate-x-4">Networking
                            And
                            CCTV</span>
                    </a>
                    <a href="#it-consultant" data-target="it-consultant"
                        ...
                        <span
                            class="absolute left-0 w-1.5 h-1.5 rounded-full bg-blue-400 opacity-0 group-hover:opacity-100 group-focus:opacity-100 transition-all duration-300 scale-0 group-hover:scale-100 group-focus:scale-100"></span>
                        <span
                            class="transition-transform duration-300 group-hover:translate-x-4 group-focus:translate-x-4">IT
                            Consultant</span>
                    </a>
                </div>
            </div>
            ...
            <div class="col-span-2 md:col-span-1 lg:col-span-3 flex flex-col">
                ...
                <div
                    ...
                    <div
                        class="absolute inset-0 bg-blue-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none z-10">
                    </div>
