<div id="toast-container"
    ...
    @if (session('success'))
        <div
            class="toast-alert bg-white border border-primary/20 shadow-[0_4px_12px_rgba(0,0,0,0.05)] rounded-md p-3.5 flex items-start gap-3 w-max min-w-[300px] max-w-md pointer-events-auto transform transition-all duration-300 opacity-0 scale-95">
            <div class="bg-primary/10 p-1.5 rounded-full shrink-0">
