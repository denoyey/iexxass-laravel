...
<div class="mt-6 sm:mt-8 flex items-center justify-end gap-2 sm:gap-3 pt-4 sm:pt-5 border-t border-gray-100">
    ...
    <button type="submit"
        class="px-3 sm:px-4 py-1.5 sm:py-2 text-[12px] sm:text-[13px] font-medium text-white bg-primary hover:bg-primary-dark rounded-md transition-colors shadow-sm">
        {{ $submitLabel }}
    </button>
</div>
