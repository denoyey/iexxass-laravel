        ...
        <div
            ...
            <div class="flex-1 p-2.5 sm:p-3 flex flex-col justify-center">
                <input type="file" id="{{ $id }}" name="{{ $name }}" accept="{{ $accept }}"
                    ...
                    class="w-full text-[11px] sm:text-[13px] text-gray-600 file:cursor-pointer file:mr-3 file:py-1.5 file:px-3 file:rounded-md file:border-0 file:text-[11px] file:font-medium file:bg-primary/10 file:text-primary hover:file:bg-primary/20 transition-colors focus:outline-none bg-transparent">
            ...
            <div
                ...
                <div class="relative">
                    <input type="number" id="compression_{{ $id }}" name="compression_{{ $name }}"
                        ...
                        class="w-16 pl-2 pr-5 py-1.5 border border-gray-300 rounded-md focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-colors text-gray-700 text-[12px] sm:text-[13px] bg-white text-center font-semibold shadow-sm">
                    <span
