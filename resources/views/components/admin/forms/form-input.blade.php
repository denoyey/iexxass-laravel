    ...
    <div class="relative">
        @if ($type === 'textarea')
            <textarea name="{{ $name }}" id="{{ $name }}" rows="{{ $rows }}" {{ $required ? 'required' : '' }}
                {{ $readonly ? 'readonly' : '' }}
                class="w-full text-gray-900 bg-white text-[12px] sm:text-[13px] px-3 py-1.5 sm:py-2 border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all placeholder:text-gray-400"
        ...
        @elseif($type === 'password')
            <input type="password" name="{{ $name }}" id="{{ $name }}" value="{{ old($name, $value) }}"
                ...
                class="w-full text-gray-900 bg-white text-[12px] sm:text-[13px] px-3 py-1.5 sm:py-2 pr-10 border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all placeholder:text-gray-400"
