        ...
        <div id="global-search-panel"
            ...
            <template id="global-search-result-template">
                <li class="cursor-pointer select-none px-4 py-1.5 hover:bg-transparent group transition-colors"
                    role="option">
                    <a href="#"
                        class="search-result-link flex items-center gap-3 w-full outline-none bg-gray-50 hover:bg-primary/30 focus:bg-primary/30 border border-gray-100 hover:border-primary/40 focus:border-primary/40 rounded-md px-3 py-2.5 transition-all shadow-sm">
                        <div
                            class="flex h-7 w-7 items-center justify-center rounded bg-white text-gray-400 group-hover:text-primary group-focus:text-primary border border-gray-100 group-hover:border-primary/30 group-focus:border-primary/30 shadow-sm shrink-0 search-result-icon-wrapper transition-colors">
                        ...
                        <svg class="h-4 w-4 text-gray-400 group-hover:text-primary group-focus:text-primary transition-colors shrink-0"
