    ...
    <div class="relative bg-white rounded-md shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col m-4">
        ...
        <div
            ...
            <div class="flex items-center gap-1 bg-gray-100 p-1 rounded-md">
                <button type="button"
                    class="cropper-tool-btn p-2 text-gray-600 hover:bg-white hover:text-primary rounded-md transition-all shadow-sm"
            ...
            <div class="flex items-center gap-2 w-full sm:w-auto">
                ...
                <button type="button" id="btn-save-cropper"
                    class="flex-1 sm:flex-none px-4 py-2 bg-primary border border-transparent text-white text-[13px] font-semibold rounded-md hover:bg-primary-dark transition-colors shadow-sm">
                    Terapkan Potongan
                </button>
            </div>
        </div>
