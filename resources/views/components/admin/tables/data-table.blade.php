...
<div class="bg-white border border-gray-200 rounded-md shadow-sm overflow-hidden data-table-wrapper">
    <div
        ...
        <div class="data-table-right-container flex items-center justify-end gap-2 sm:gap-3 w-full sm:w-auto sm:ml-auto">
                ...
                @if ($livewire)
                    <div class="flex-1 sm:flex-none relative">
                        <input type="text" wire:model.live.debounce.300ms="search" name="search" id="search_input"
                            ...
                            class="w-full sm:w-[180px] pl-8 pr-3 py-1.5 text-[12.5px] border border-gray-300 rounded-md focus:ring-1 focus:ring-primary focus:border-primary focus:outline-none transition-colors">
            ...
            @if ($createRoute)
                <a href="{{ $createRoute }}"
                    class="px-2.5 py-1.5 sm:px-3.5 sm:py-1.5 bg-primary hover:bg-primary-dark text-white text-[11px] sm:text-[12.5px] font-medium rounded-md transition-colors flex items-center justify-center gap-1.5 shrink-0">
    ...
    <div class="overflow-x-auto scrollbar-thin">
        <table class="w-full min-w-[600px] text-left text-[13px]">
            ...
            <tbody class="divide-y divide-gray-100 text-gray-700 data-table-body transition-opacity duration-200"
                @if ($sortableRoute) data-sortable="true" data-sortable-route="{{ $sortableRoute }}" @endif>
