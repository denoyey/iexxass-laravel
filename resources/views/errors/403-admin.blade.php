    ...
    <div class="w-full flex flex-col items-center justify-center min-h-[65vh]">
        <div class="w-full text-center flex flex-col items-center">
            ...
            <a href="{{ route('admin.dashboard') }}"
                class="inline-flex items-center justify-center gap-1.5 px-4 py-1.5 sm:px-5 sm:py-2 text-[13px] sm:text-sm font-medium text-white bg-primary hover:bg-opacity-90 rounded transition-colors">
