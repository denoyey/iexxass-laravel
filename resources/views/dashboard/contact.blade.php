<div style="background-image: url('src/img/bg-footer.png') "
    ...
    <div class="w-full h-full relative py-10 md:py-45 grid md:grid-cols-1 md:grid-cols-2">
        <div class=" container md:order-1 order-2  ">
            ...
            <!--@endif-->
            <form method="POST" action="{{ route('contact.us') }}" id="contactForm" class="max-w-sm mx-auto font-AbhayaLibre px-[10px]">
                @csrf
        ...
        <div
            ...
            <h1 class="header text-[25px] lg:text-[35px] xl:text-[45px] tracking-[5px] md:tracking-[12px]">CONTACT US! REACH
