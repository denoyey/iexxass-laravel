...
Route::prefix('/ix-core')->name('admin.')->group(function () {
    ...
    Route::middleware(['auth', 'permission:access_admin_panel', 'prevent-back-history', 'prevent-spam'])->group(function () {
        ...
        Route::post('projects/reorder', [ProjectController::class, 'reorder'])
            ...
            ->withoutMiddleware('prevent-spam')
            ->middleware('throttle:60,1');
        Route::delete('projects/delete-all-images/{id_project}', [ProjectController::class, 'destroyAllImages'])->name('projects.destroy-all-images');
        Route::post('projects/update-image/{id_project_image}', [ProjectController::class, 'updateImage'])->name('projects.update-image');
        Route::delete('projects/delete-image/{id_project_image}', [ProjectController::class, 'destroyImage'])->name('projects.destroy-image');
